...
define view entity ZC_DXBOOKING_D as projection on ZI_DXBOOKING__D
{
  key BookingUUID,
...
//        ]
     @Consumption.valueHelpDefinition: [ {entity: {name: '/DMO/I_Flight', element: 'ConnectionID'},
      ...
      /* Associations */
      _BookingSupplement : redirected to composition child ZC_DXBOOKSUPL_D,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZC_DXTRAVEL_D
}
